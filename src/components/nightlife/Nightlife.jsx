...
import { nightLife } from "../../data/nightfall";
  ...
  return (
    <div>
      ...
      <div className="max-width">
        <Filter filterLists={nightFilters}/>
        <ExploreSection list={nightLifeList} collectionName="Nightlife Restaurants in Bagherhat" />
      </div>
